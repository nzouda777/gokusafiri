...
const GUIDES = [
    {
        ...
        years: 12,
        bio: 'Kofi grew up near the Maasai Mara and has tracked the Great Migration every year since he was a teenager. He holds a Kenya Professional Safari Guide Level 3 certification.',
        img: '/images/trust-avatar-1.jpg',
    ...
    },
    {
        ...
        years: 8,
        bio: "With over 900 bird species identified in the field, Ama is one of East Africa's most sought-after birding guides. She is also a trained botanist and ecology interpreter.",
        img: '/images/trust-avatar-2.jpg',
        tags: ['Birding', 'Ecology', 'Serengeti'],
    },
    {
        name: 'Tendai Moyo',
        country: 'Zimbabwe',
        specialty: 'Walking Safaris',
        years: 15,
        bio: 'Tendai is a ZPWMA-certified walking safari guide who has spent 15 years leading guests through Hwange and Mana Pools. Walking with Tendai is an immersive, unhurried experience.',
        img: '/images/trust-avatar-3.jpg',
        tags: ['Walking safaris', 'Hwange', 'Mana Pools'],
    },
    {
        name: 'Fatou Camara',
        country: 'Senegal',
        specialty: 'Culture & Communities',
        years: 10,
        bio: 'Fatou bridges traditional West African cultures with modern travel. She speaks six languages and has facilitated life-changing community exchanges across Senegal and Guinea.',
        img: null,
        tags: ['Culture', 'West Africa', 'Languages'],
    },
    {
        name: 'Sipho Dlamini',
        country: 'South Africa',
        specialty: 'Marine & Coastal',
        years: 7,
        bio: 'Based in Cape Town, Sipho specialises in whale watching, shark cage diving, and the fynbos biome. He holds a FGASA Field Guide certification and a marine biology degree.',
        img: null,
        tags: ['Marine', 'Cape Town', 'Whale watching'],
    },
    {
        name: 'Aisha Nakuya',
        country: 'Uganda',
        ...
        years: 9,
        bio: 'Aisha is one of only a handful of guides certified to lead mountain gorilla treks in Bwindi Impenetrable Forest. She is also an active advocate for primate conservation.',
        img: null,
        tags: ['Gorillas', 'Bwindi', 'Conservation'],
    },
];
