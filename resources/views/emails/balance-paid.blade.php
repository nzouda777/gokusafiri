...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
    ...
    <tr>
        <td style="padding:10px 0 0;font-size:14px;color:#16241b;font-weight:700;">Total Paid in Full</td>
...
<div style="background-color:#eef3ec;border-radius:12px;padding:20px 24px;margin-bottom:28px;">
    <p style="margin:0 0 10px;font-size:13px;font-weight:700;color:#2E4A39;text-transform:uppercase;letter-spacing:0.5px;">Everything is confirmed</p>
    <p style="margin:0 0 6px;font-size:13px;color:#4f5c53;">✅ &nbsp;Payment received in full</p>
    <p style="margin:0 0 6px;font-size:13px;color:#4f5c53;">✅ &nbsp;Booking confirmed</p>
    <p style="margin:0;font-size:13px;color:#4f5c53;">📋 &nbsp;Travel documents will arrive 2 weeks before departure</p>
</div>

<p style="margin:0;font-size:14px;color:#4f5c53;text-align:center;">
    No more payments needed. Just start packing! 🧳
</p>
