...
<div style="margin-bottom:24px;font-size:15px;line-height:1.7;color:#4f5c53;">
    {!! $body !!}
</div>

{{-- Dynamic blocks (trip summary, guide/driver/hotel info, checklists, referral...) --}}
@foreach($blocks as $block)
    {!! $block !!}
@endforeach

@if($discountCode)
<div style="background-color:#f5f2ec;border:1px dashed #c5d3c8;border-radius:10px;padding:16px 20px;margin-bottom:24px;text-align:center;">
